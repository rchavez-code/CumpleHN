...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        /* La limpieza del HTML del modelo vive en cumplehn-respuesta-ia.js,
           compartida con el reporte de consultas. Ahí está explicada. */
        var pintarRespuesta = window.CumpleHN.pintarRespuestaIA;
